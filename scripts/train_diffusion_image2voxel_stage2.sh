...
python -m occupancy.pipelines.train --model panoramic2voxel --data-dir '/mnt/f/datasets/nuscenes/' \
    ...
    --dtype bf16 --model-config config/diffusion_image2voxel.yml --grad-accum 128 --save-every 100 --weight-decay 1.0e-5 --lr 1.0e-4 \
    --warmup-steps 10 --num-classes 18 --ema
